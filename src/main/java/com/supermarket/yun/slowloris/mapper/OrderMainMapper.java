...
import com.supermarket.yun.slowloris.domain.OrderMain;
...
public interface OrderMainMapper {
    /**
     * @mbg.generated 2017-11-13 51:21:392
     */
    @Delete({
     ...
     */
    @Insert({
            "insert into order_main (buyer_id, shop_id, ",
            "shop_name, payment, ",
            "delivery_type, consignee_name, ",
            "consignee_phone, consignee_address, ",
            "verification_code, order_comment, ",
            "shipping_fee, total_pay, ",
            "total_cost, pay_price, ",
            "pay_status, pay_time, ",
            "pay_transaction, pay_check, ",
            "order_status, order_time, ",
            "cancel_time, cancel_by, ",
            "sign_time, sign_by, ",
            "split_transfer, update_by, ",
            "update_time, version, ",
            "remarks)",
            "values (#{buyerId,jdbcType=INTEGER}, #{shopId,jdbcType=INTEGER}, ",
            "#{shopName,jdbcType=VARCHAR}, #{payment,jdbcType=INTEGER}, ",
            "#{deliveryType,jdbcType=INTEGER}, #{consigneeName,jdbcType=VARCHAR}, ",
            "#{consigneePhone,jdbcType=VARCHAR}, #{consigneeAddress,jdbcType=VARCHAR}, ",
            "#{verificationCode,jdbcType=VARCHAR}, #{orderComment,jdbcType=VARCHAR}, ",
            "#{shippingFee,jdbcType=DECIMAL}, #{totalPay,jdbcType=DECIMAL}, ",
            "#{totalCost,jdbcType=DECIMAL}, #{payPrice,jdbcType=DECIMAL}, ",
            "#{payStatus,jdbcType=INTEGER}, #{payTime,jdbcType=TIMESTAMP}, ",
            "#{payTransaction,jdbcType=VARCHAR}, #{payCheck,jdbcType=VARCHAR}, ",
            "#{orderStatus,jdbcType=INTEGER}, #{orderTime,jdbcType=TIMESTAMP}, ",
            "#{cancelTime,jdbcType=TIMESTAMP}, #{cancelBy,jdbcType=VARCHAR}, ",
            "#{signTime,jdbcType=TIMESTAMP}, #{signBy,jdbcType=VARCHAR}, ",
            "#{splitTransfer,jdbcType=INTEGER}, #{updateBy,jdbcType=VARCHAR}, ",
    ...
    @Select({
            "select",
            "id, buyer_id, shop_id, shop_name, payment, delivery_type, consignee_name, consignee_phone, ",
            "consignee_address, verification_code, order_comment, shipping_fee, total_pay, ",
            "total_cost, pay_price, pay_status, pay_time, pay_transaction, pay_check, order_status, ",
            "order_time, cancel_time, cancel_by, sign_time, sign_by, split_transfer, update_by, ",
            "update_time, version, remarks",
            "from order_main",
            "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({

...
import com.supermarket.yun.slowloris.domain.OrderItemSplit;
...
@Mapper
public interface OrderItemSplitMapper {
    /**
     * @mbg.generated 2017-11-13 51:21:369
     */
    @Delete({
            "delete from order_item_split",
     ...
     */
    @Insert({
            "insert into order_item_split (order_id, product_id, ",
    ...
    int insert(OrderItemSplit record);
    ...
    OrderItemSplit selectByPrimaryKey(Integer id);
    ...
    List<OrderItemSplit> selectAll();

    /**
     * @mbg.generated 2017-11-13 51:21:369
     */
    @Update({
            "update order_item_split",
    ...
    int updateByPrimaryKey(OrderItemSplit record);
}